...
fid=fopen(['./homo/traveltime_2ndFSM.dat'],'r');
...
text(-0.1, 1.05, '(d)', 'FontSize', 30, 'FontName', 'Times New Roman', ...
     'HorizontalAlignment', 'center', 'VerticalAlignment', 'top', ...
     'Units', 'normalized', 'Parent', gca, 'FontWeight', 'bold');
set(gca, 'YDir', 'reverse', 'FontSize', 25);
legend('Analytical','Second-order FSM', 'FontSize', 25, 'FontName', 'Times New Roman', Location='south',Orientation='horizontal');
...
% axis tight;
set(gca, 'YDir', 'reverse', 'FontSize', 25);
text(-0.12, 1.05, '(e)', 'FontSize', 30, 'FontName', 'Times New Roman', ...
     'HorizontalAlignment', 'center', 'VerticalAlignment', 'top', ...
     'Units', 'normalized', 'Parent', gca, 'FontWeight', 'bold');
caxis([0 0.01]);
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
xlabel('Distance, km', 'FontSize', 25, 'FontName', 'Times New Roman');
ylabel('Depth, km', 'FontSize', 25, 'FontName', 'Times New Roman');
text(-0.12, 1.05, '(f)', 'FontSize', 30, 'FontName', 'Times New Roman', ...
     'HorizontalAlignment', 'center', 'VerticalAlignment', 'top', ...
     'Units', 'normalized', 'Parent', gca, 'FontWeight', 'bold');
clabel(C, h, 'FontSize', 10, 'Color', 'k', 'LabelSpacing', 300);
set(gca, 'YDir', 'reverse', 'FontSize', 25);
print("./tiff/homo_high_order_fsm", '-dtiff', '-r500');