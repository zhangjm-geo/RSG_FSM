...
fid=fopen(['./homo/traveltime_FSM.dat'],'r');
% fid=fopen(['/media/lqq/Data/wang/codes/Eikonal_FSM/wang/traveltime_2ndFSM.dat'],'r');
% fid=fopen(['/media/lqq/Data/wang/codes/Eikonal_FSM/wang/traveltime_stagered_FSM.dat'],'r');
...
figure('units','normalized','position',[0.05,0.05,0.9,0.45]);
...
text(-0.1, 1.05, '(a)', 'FontSize', 30, 'FontName', 'Times New Roman', ...
     'HorizontalAlignment', 'center', 'VerticalAlignment', 'top', ...
     'Units', 'normalized', 'Parent', gca, 'FontWeight', 'bold');
set(gca, 'YDir', 'reverse', 'FontSize', 25);
legend('Analytical','FSM', 'FontSize', 25, 'FontName', 'Times New Roman', Location='south',Orientation='horizontal');
...
% axis tight;
set(gca, 'YDir', 'reverse', 'FontSize', 25);
text(-0.12, 1.05, '(b)', 'FontSize', 30, 'FontName', 'Times New Roman', ...
     'HorizontalAlignment', 'center', 'VerticalAlignment', 'top', ...
     'Units', 'normalized', 'Parent', gca, 'FontWeight', 'bold');
caxis([0 0.01]);
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
xlabel('Distance, km', 'FontSize', 25, 'FontName', 'Times New Roman');
ylabel('Depth, km', 'FontSize', 25, 'FontName', 'Times New Roman');
text(-0.12, 1.05, '(c)', 'FontSize', 30, 'FontName', 'Times New Roman', ...
     'HorizontalAlignment', 'center', 'VerticalAlignment', 'top', ...
     'Units', 'normalized', 'Parent', gca, 'FontWeight', 'bold');
clabel(C, h, 'FontSize', 10, 'Color', 'k', 'LabelSpacing', 250);
set(gca, 'YDir', 'reverse', 'FontSize', 25);
% print("./tiff/homo_fsm", '-dtiff', '-r500');