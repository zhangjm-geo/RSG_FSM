...
# Example
 We test on the constant velocity model with a velocity of 1000 m/s on a 101 × 101 mesh, using 10 m spatial intervals. The source location xs is set at (510 m, 510 m). 
 <pre><code>
make
</code></pre>
 <pre><code>
